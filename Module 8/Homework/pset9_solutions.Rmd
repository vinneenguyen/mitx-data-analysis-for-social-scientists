...
signif_level_obs <- pf(f_stat, df1 = num_rest, df2 = df_unrest, tail.lower = FALSE)
signif_level_obs
...
"Probability of observing F's more extreme than F-test statistic, under null '2(Beta 1) = (Beta 2)', is insignificant (<= required)?"
signif_level_obs <= signif_level_req
```
